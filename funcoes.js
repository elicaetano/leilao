function vaiindex() { window.location.href = "index.html"; }
function vaiLogin() { window.location.href = "longin.html"; }
function vaiLance() {
  if( getUser() != "" ) window.location.href = "principal.html";
  else document.getElementById( "saida" ).innerHTML = "Você não tem acesso";
}
